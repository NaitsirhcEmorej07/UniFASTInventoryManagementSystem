            ...
            <div class="modal-content">
                ...
                <form action="" method="POST">
                        ...
                        <div class="modal-body">
                           <div class="row">
                                <div class="col-10">
                                    <label style="font-size:17px" id="enduser">......</label>   <br>   
                                    <label style="font-size:16px" id="position">......</label> <br>
                                    <label style="font-size:16px" id="unit1">......</label>  <br>
                                </div>
                                <div class="col-2">
                           ...
                           <div class="row">
                                <div class="col-12">
                                <table id="tablestaffitems" class="table table-striped" style="width: 100%; font-size:15px;">
                                    <thead>
                                        <tr>
