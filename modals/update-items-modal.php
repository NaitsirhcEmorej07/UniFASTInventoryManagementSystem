...
if (isset($_POST['submitBTN'])) {
    $itemid = $_POST['itemid'];
    $item = $_POST['item'];
    $item_description = $_POST['item-desc'];
...
<body>
    <div class="modal fade" id="update-items-modal" tabindex="-1" aria-labelledby="modal-title" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input id="item-desc" name="item-desc" type="text" class="form-control" required>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="text" id="supplier_contact" name="supplier_contact" class="form-control" required>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                ...
                                <input type="number" id="supplier_warranty" name="supplier_warranty" class="form-control" required>
                            </div>
                            ...
                            <div class="col-6 mb-2">
                                <label>
                                    ...
                                    Date Acquired</label>
                                <input type="date" id="date_acquired" name="date-acquired" class="form-control" required>
                            </div>
                            ...
                            <div class="col-6 mb-3">
                                <label>
                                    ...
                                    Received From</label>
                                <input type="text" id="received_from" name="received-from" class="form-control" required>
                            </div>
