...
if (isset($_POST['submitBTNstaff'])) {
    ...
    $sql = "insert into " . $TBL_UNIFAST_STAFF  . "
    (id_no,
	first_name, 
	middle_name, 
	last_name, 
    ...
    values(
    UPPER('$id_no'), 
    UPPER('$staff_first_name'), 
    UPPER('$staff_middle_name'), 
    UPPER('$staff_last_name'), 
    UPPER('$staff_prefix_name'), 
    UPPER('$staff_suffix_name'), 
    UPPER('$staff_title_name'), 
    UPPER('$designation'),
    UPPER('$unit'),
    UPPER('$abbrebiation'),
    UPPER('$emp_type'),
                ...
                <form action="" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <!-- <input hidden type="text" name="full_name" class="form-control" placeholder="LASTNAME,  FIRSTNAME,  MIDDLENAME" autocomplete="off" required> -->
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="staff_middle_name" class="form-control" placeholder="MIDDLE NAME" autocomplete="off">
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <input type="text" name="staff_prefix_name" class="form-control" placeholder="PREFIX" autocomplete="off">
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <select type="unit" name="staff_suffix_name" class="form-select" aria-label="Default select example">
                            ...
                            <div class="col-4 mb-4">
                                ...
                                <input type="text" name="staff_title_name" class="form-control" placeholder="TITLE" autocomplete="off">
                            </div>
